    ...
    <div style={{ padding: "24px" }}>
      ...
      >
        <option value={Categories.TO_DO} style={{ color: "#000" }}>
          ToDo (
          {allToDos.filter((toDo) => toDo.category === Categories.TO_DO).length}
          )
        </option>
        <option value={Categories.DOING} style={{ color: "#000" }}>
          Doing (
          {allToDos.filter((toDo) => toDo.category === Categories.DOING).length}
          )
        </option>
        <option value={Categories.DONE} style={{ color: "#000" }}>
          Done (
          {allToDos.filter((toDo) => toDo.category === Categories.DONE).length})
        </option>
      </select>
      {toDos.map((toDo) => (
